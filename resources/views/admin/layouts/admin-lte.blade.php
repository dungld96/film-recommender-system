...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Film</b>Recommender</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ route('quan-ly-phim') }}"><i class="fa fa-circle-o text-red"></i> <span>Quản lý phim</span></a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="dungle.ml">Dũng Lê</a>.</strong> 
  </footer>
